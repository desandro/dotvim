" Vim color file
" Converted from Textmate theme Sunburst tweak 01 using Coloration v0.2.5 (http://github.com/sickill/coloration)
...
let g:colors_name = "Sunburst tweak 01"

hi Cursor  guifg=NONE guibg=#a7a7a7 gui=NONE
hi Visual  guifg=NONE guibg=#3e4449 gui=NONE
...
hi Pmenu  guifg=#88bdfe guibg=NONE gui=NONE
hi PmenuSel  guifg=NONE guibg=#3e4449 gui=NONE
...
hi Folded  guifg=#636363 guibg=#000000 gui=NONE
...
hi Comment  guifg=#636363 guibg=NONE gui=italic
...
hi Function  guifg=#88bdfe guibg=NONE gui=NONE
hi Identifier  guifg=#99cf4f guibg=NONE gui=NONE
hi Keyword  guifg=#e28964 guibg=NONE gui=NONE
hi Label  guifg=#63af40 guibg=NONE gui=NONE
hi NonText  guifg=#023b0b guibg=#1a1a1a gui=NONE
...
hi SpecialKey  guifg=#023b0b guibg=#1a1a1a gui=NONE
hi Statement  guifg=#e28964 guibg=NONE gui=NONE
hi StorageClass  guifg=#99cf4f guibg=NONE gui=NONE
hi String  guifg=#63af40 guibg=NONE gui=NONE
hi Tag  guifg=#88bdfe guibg=NONE gui=NONE
...
hi rubyConstant  guifg=#9a859c guibg=NONE gui=NONE
hi rubyStringDelimiter  guifg=#63af40 guibg=NONE gui=NONE
hi rubyBlockParameter  guifg=#3e87e2 guibg=NONE gui=NONE
hi rubyInstanceVariable  guifg=#3e87e2 guibg=NONE gui=NONE
hi rubyInclude  guifg=#e28964 guibg=NONE gui=NONE
hi rubyGlobalVariable  guifg=#3e87e2 guibg=NONE gui=NONE
...
hi rubyClassVariable  guifg=#3e87e2 guibg=NONE gui=NONE
hi rubyOperator  guifg=#e28964 guibg=NONE gui=NONE
hi rubyException  guifg=#e28964 guibg=NONE gui=NONE
hi rubyPseudoVariable  guifg=#3e87e2 guibg=NONE gui=NONE
hi rubyRailsUserClass  guifg=#9a859c guibg=NONE gui=NONE
...
hi erubyComment  guifg=#636363 guibg=NONE gui=italic
hi erubyRailsMethod  guifg=#dad085 guibg=NONE gui=NONE
hi htmlTag  guifg=#87bdfd guibg=NONE gui=NONE
hi htmlEndTag  guifg=#87bdfd guibg=NONE gui=NONE
...
hi yamlDocumentHeader  guifg=#63af40 guibg=NONE gui=NONE
hi cssURL  guifg=#3e87e2 guibg=NONE gui=NONE
hi cssFunctionName  guifg=#dad085 guibg=NONE gui=NONE
hi cssColor  guifg=#3387cc guibg=NONE gui=NONE
hi cssPseudoClassId  guifg=#88bdfe guibg=NONE gui=NONE
hi cssClassName  guifg=#88bdfe guibg=NONE gui=NONE
